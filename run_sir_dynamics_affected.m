...
[N,Y] = ode45(@(n,y)sir_dynamics_linear_affected(n,y,delta),[0 200],[0.999;0.001],options);

[M,Z] = ode45(@(m,z)sir_dynamics_nonlinear_affected(m,z,delta),[0 200],[0.999;0.001],options);
